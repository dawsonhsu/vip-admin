...
export const mockDispatchTasks: BatchDispatchTask[] = [
  {
    id: `BAT-${dayjs().format('YYYYMMDD')}-1842`,
    activityName: 'VIP 週末 Free Spin',
    operator: 'darren@filbetph.com',
    submittedAt: dayjs().hour(15).minute(20).second(8).format('YYYY-MM-DD HH:mm:ss'),
    finishedAt: dayjs().hour(15).minute(20).second(13).format('YYYY-MM-DD HH:mm:ss'),
    total: 120,
    processed: 120,
    successCount: 120,
    failedCount: 0,
  ...
  {
    id: `BAT-${dayjs().subtract(1, 'day').format('YYYYMMDD')}-9265`,
    activityName: '新遊戲推廣',
    operator: 'ops.alice@filbetph.com',
    submittedAt: dayjs().subtract(1, 'day').hour(11).minute(5).second(20).format('YYYY-MM-DD HH:mm:ss'),
    finishedAt: dayjs().subtract(1, 'day').hour(11).minute(5).second(25).format('YYYY-MM-DD HH:mm:ss'),
    total: 50,
    processed: 50,
    successCount: 47,
    failedCount: 3,
  ...
  {
    id: `BAT-${dayjs().format('YYYYMMDD')}-4307`,
    activityName: '測試會員批次',
    operator: 'risk.bob@filbetph.com',
    submittedAt: dayjs().hour(9).minute(42).second(10).format('YYYY-MM-DD HH:mm:ss'),
    finishedAt: dayjs().hour(9).minute(42).second(14).format('YYYY-MM-DD HH:mm:ss'),
    total: 2,
    processed: 2,
    successCount: 0,
    failedCount: 2,
